...
export default function RuchiVedhikaPage() {
    ...
    return (
        <div className="branchPageContainer">
            ...
            <h1 className="branchTitle" style={{ color: '#feca57' }}>Ruchi Vedhika Branch</h1>
            <p className="branchSubtitle">
                Welcome to the Ruchi Vedhika management page.
            </p>
            ...
            <BranchStats restaurantId="12" onDetailsLoaded={setDetails} />
        </div>
    );
}
