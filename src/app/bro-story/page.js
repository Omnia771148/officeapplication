...
export default function BroStoryPage() {
    ...
    return (
        <div className="branchPageContainer">
            ...
            <h1 className="branchTitle" style={{ color: '#FF9F43' }}>Bro Story Branch</h1>
            <p className="branchSubtitle">
                Welcome to the Bro Story management page.
            </p>
            ...
            <BranchStats restaurantId="6" onDetailsLoaded={setDetails} />
        </div>
    );
}
