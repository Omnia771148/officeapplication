...
export default function PrGrandPage() {
    ...
    return (
        <div className="branchPageContainer">
            ...
            <h1 className="branchTitle" style={{ color: '#FD79A8' }}>PR Grand Branch</h1>
            <p className="branchSubtitle">
                Welcome to the PR Grand management page.
            </p>
            ...
            <BranchStats restaurantId="8" onDetailsLoaded={setDetails} />
        </div>
    );
}
